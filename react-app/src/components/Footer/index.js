  ...
  return (
    <div className="footer-container">
      <div className="footer-banner">
        <span>Check out our socials below!</span>
      </div>
      <div className="footer-icon-link-container">
        <div className="footer-icons">
          ...
          <div className="footer-links">
            <li>
              <a href="https://github.com/Baluyotkevin">
        ...
        <div className="footer-icons">
          ...
          <div className="footer-links">
            <li>
              <a href="https://github.com/Mattchu18">
                <i class="fa-brands fa-github"></i>
                <span class="label"> GitHub</span>
              </a>
            </li>
            <li>
              <a href="https://www.linkedin.com/in/matt-aung/">
                <i class="fa-brands fa-linkedin"></i>
                <span class="label"> Linkedin</span>
              </a>
            </li>
        ...
        <div className="footer-icons">
          ...
          <div className="footer-links">
            <li>
              <a href="https://github.com/tohknee">
                <i class="fa-brands fa-github"></i>
                <span class="label"> GitHub</span>
              </a>
            </li>
            <li>
              <a href="https://www.linkedin.com/in/tonyhedev/">
                <i class="fa-brands fa-linkedin"></i>
                <span class="label"> Linkedin</span>
              </a>
            </li>
